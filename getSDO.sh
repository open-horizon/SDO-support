...
echo "Retrieving Intel SDO Release 1.10.6 dependencies..."
...
chk $? 'downloading pri'
tar -zxf pri-v1.10.6.tar.gz
chk $? 'unpacking pri'

echo "Getting NOTICES"
curl --progress-bar -LO https://github.com/secure-device-onboard/release/releases/download/v1.10.6/NOTICES-v1.10.6.tar.gz
chk $? 'downloading NOTICES'
tar -zxf NOTICES-v1.10.6.tar.gz
chk $? 'unpacking NOTICES'

echo "Getting Rendezvous Service"
curl --progress-bar -LO https://github.com/secure-device-onboard/release/releases/download/v1.10.6/rendezvous-service-v1.10.6.tar.gz
chk $? 'downloading RV'
tar -zxf rendezvous-service-v1.10.6.tar.gz
chk $? 'unpacking RV'

echo "Getting Supply Chain Tools"
curl --progress-bar -LO https://github.com/secure-device-onboard/release/releases/download/v1.10.6/supply-chain-tools-v1.10.6.tar.gz
chk $? 'downloading SCT'
tar -zxf supply-chain-tools-v1.10.6.tar.gz
chk $? 'unpacking SCT'
