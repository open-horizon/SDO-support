...
Optional Environment Variables:
  SDO_MFG_IMAGE_TAG - version of the manufacturer and manufacturer-mariadb docker images that should be used. Defaults to '1.8'.
...
SDO_MFG_IMAGE_TAG=${SDO_MFG_IMAGE_TAG:-1.8}
